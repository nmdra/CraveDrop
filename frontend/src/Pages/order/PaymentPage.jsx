...
const stripePromise = loadStripe('pk_test_51RErI8RaMVEyYN7k9JSNZHcktzyVq8fybSIc3KZshl2I2Iy5Q8VJcGgp716TC4MzTKySp7xsy5lrbVMh9gb0s0wb00dvEjXEc2');
    ...
    try {
      ...
      if (paymentIntent.status === 'succeeded') {
        try {
          ...
          const rawItems = JSON.parse(localStorage.getItem('paymentItems'));
          ...
          console.log('Payment successful, creating order with data:', {
            userId: 'user-123',
          ...
          ['cart', 'checkoutItems', 'paymentClientSecret', 'paymentItems', 
           'paymentAddress', 'paymentPhone', 'paymentMethod']
          ...
          if (error.response) {
            ...
            alert(`Payment successful but order creation failed: ${error.response.data.message || error.message}`);
          } else {
...
function PaymentPage() {
  ...
  if (!clientSecret) {
    return <div className="text-center mt-10">Loading Payment...</div>;
  }
